...
# Carregando os dados
dados = 'D:/Localiza/dados/df_fraud_credit.csv'
df = pd.read_csv(dados)

# Data Quality
def monitorar_qualidade_dados(df):
    # Coluna amount para numerico substituindo valores invalidos por nan
...
# Filtrando transaces do tipo sale e dropando valores ausentes da coluna amount
